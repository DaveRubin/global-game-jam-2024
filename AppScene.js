...
var createScene = function (engine, canvas) {
  ...
  let spriteSheet = new BABYLON.Texture(
    "textures/spriteMap/none_trimmed/Legends_Level_A.png",
    scene,
    false, //NoMipMaps
  ...
  const textTask = assetsManager.addTextFileTask(
    "text task",
    "textures/spriteMap/none_trimmed/Legends_Level_A.json"
  );
